...
const translations: Translations = {
    en: {
        ...
        "about.page.mission": "Our Mission",
        "about.page.mission.desc": "We're actively Upscale and Transform everything we touch",
        "about.page.whatwedo": "What We Do",
        "about.page.whatwedo.p1": "We're a multi-sector Company with a singular obsession: reimagining the essential. While our portfolio spans a diverse array of established B2B industries, our approach is focused. We are no status quo we value add; we disrupt them from within, transforming traditional market standards into unique, innovative advantages for partners worldwide.",
        "about.page.whatwedo.p2": "We deliver innovation to a diverse global landscape. Our expertise lies in taking known, known industries and engineering them into something unique for our customers. By combining customer needs enabling them to execute their strategy efficiently and uniquely to become market leaders in their space. Diverse presence, singular excellence.",
        "about.page.whatwedo.p3": "Your supplier partners shouldn't just be reliable; it should be a competitive advantage. We give you a unique lens of innovation to known industries, we deliver specialized solutions that stand out in a crowded market. For our partners, this means access to a diverse portfolio of services that aren't just standard—they are produced to be distinct, giving your business a smarter, sharper foundation to deliver your business outcomes.",
        ...
        "partner.extended.title": "We create products — by identifying market trends and opportunities",
        ...
        "partner.extended.p3": "Our products fit the market – we identify market trends and innovate for you.",
        ...
        "impressum.constructionText": "This website is currently being developed and will be fully operational by the end of Febuary 2026. All contact information provided below remains valid and can be used for inquiries.",
        ...
        "impressum.managing": "Geschäftsführender Gesellschafter",
    ...
    de: {
        ...
        "about.page.mission": "Unsere Mission",
        "about.page.mission.desc": "Wir skalieren und transformieren aktiv alles, was wir berühren",
        "about.page.whatwedo": "Was wir tun",
        "about.page.whatwedo.p1": "Wir sind ein Multi-Sektor-Unternehmen mit einer besonderen Obsession: das Wesentliche neu zu denken. Während unser Portfolio eine vielfältige Palette etablierter B2B-Branchen umfasst, ist unser Ansatz fokussiert. Wir sind kein Status quo, den wir ergänzen; wir stören ihn von innen heraus und verwandeln traditionelle Marktstandards in einzigartige, innovative Vorteile für Partner weltweit.",
        "about.page.whatwedo.p2": "Wir liefern Innovation in eine vielfältige globale Landschaft. Unsere Expertise liegt darin, bekannte Branchen zu nehmen und sie in etwas Einzigartiges für unsere Kunden zu verwandeln. Durch die Kombination von Kundenbedürfnissen ermöglichen wir es ihnen, ihre Strategie effizient und einzigartig umzusetzen, um Marktführer in ihrem Bereich zu werden. Vielfältige Präsenz, einzigartige Exzellenz.",
        "about.page.whatwedo.p3": "Ihre Lieferantenpartner sollten nicht nur zuverlässig sein; sie sollten ein Wettbewerbsvorteil sein. Wir geben Ihnen eine einzigartige Innovationslinse für bekannte Branchen, wir liefern spezialisierte Lösungen, die sich in einem überfüllten Markt abheben. Für unsere Partner bedeutet dies Zugang zu einem vielfältigen Portfolio von Dienstleistungen, die nicht nur Standard sind – sie werden produziert, um sich zu unterscheiden, und geben Ihrem Unternehmen eine intelligentere, schärfere Grundlage, um Ihre Geschäftsergebnisse zu liefern.",
        ...
        "partner.extended.title": "Wir schaffen Produkte — durch die Identifizierung von Markttrends und Chancen",
        ...
        "partner.extended.p3": "Unsere Produkte passen zum Markt – wir identifizieren Markttrends und innovieren für Sie.",
        ...
        "impressum.constructionText": "Diese Website befindet sich derzeit im Aufbau und wird bis Ende Februar 2026 vollständig fertiggestellt sein. Alle unten angegebenen Kontaktinformationen sind gültig und können für Anfragen genutzt werden.",
